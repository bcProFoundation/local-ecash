        ...
        <div className="right-section">
          <IconButton className="currency-filter-btn" onClick={() => setOpenCurrencyModal(true)}>
            {!currencyInfo ? (
              ...
              // Fiat currency - show country flag
              <img
                className="flag-icon"
                src={`https://flagcdn.com/w40/${currencyInfo.countryCode.toLowerCase()}.png`}
                alt={currencyInfo.code}
                onError={e => {
                  // Fallback to filter icon if flag fails to load
                  e.currentTarget.style.display = 'none';
                  e.currentTarget.parentElement!.innerHTML =
                    '<svg class="MuiSvgIcon-root MuiSvgIcon-colorPrimary" focusable="false" aria-hidden="true" viewBox="0 0 24 24"><path d="M10 18h4v-2h-4v2zM3 6v2h18V6H3zm3 7h12v-2H6v2z"></path></svg>';
                }}
              />
