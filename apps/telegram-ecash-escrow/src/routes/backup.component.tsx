...
import { useBackButton, usePopup, useMainButton, useHapticFeedback } from '@tma.js/sdk-react';
...
export const component = function Backup() {
  ...
  return (
    <ContainerBackupGame>
      ...
      <LixiButton title="Continue" onClickItem={() => navigate({ to: '/setting' })}></LixiButton>
    </ContainerBackupGame>
  );
};
